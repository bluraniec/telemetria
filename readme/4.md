...
**Nie zobaczysz teraz żadnych danych, ponieważ nasze sąsiedztwo BGP jest domyślnie ustanowione (Established). Możesz szybko sprawdzić poprawność działania przez zmianę parametru connecion-state != bgp-st-estab**  
