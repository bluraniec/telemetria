...
Warsztat ten demonstruje jak telemetria strumieniowa może być stosowana w środowisku ze zwirtualizowanymi urządzeniami Cisco IOS-XR. Uczestnicy będą mieli możliwość zbierania danych z urządzeń, analizowania ich i wizualizowania w czasie niemal rzeczywistym przy użyciu narzędzi typu open-source.
